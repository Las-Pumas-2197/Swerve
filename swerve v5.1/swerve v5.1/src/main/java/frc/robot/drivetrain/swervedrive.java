...
public class swervedrive extends SubsystemBase {
  ...
  public void driveIKinVCL(double Xspeed, double Yspeed, double Zrot, double HeadingDesired, boolean HeadingCL) {
    ...
    optimizedstates[0].speedMetersPerSecond *= Math.cos(angleerrormult*FLturnposactual - FLturnposdes);
    optimizedstates[1].speedMetersPerSecond *= Math.cos(angleerrormult*FRturnposactual - FRturnposdes);
    optimizedstates[2].speedMetersPerSecond *= Math.cos(angleerrormult*RLturnposactual - RLturnposdes);
    optimizedstates[3].speedMetersPerSecond *= Math.cos(angleerrormult*RRturnposactual - RRturnposdes);
